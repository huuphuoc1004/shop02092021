            ...
            <div class="header-section">
                ...
                <div id="navbar-collapse-1" class="navbar-collapse collapse yamm mega-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- Classic dropdown -->
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> Language  <b
                                class=" fa fa-angle-down"></b></a>
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="{{route('language.index',['vi'])}}"><span> Tiếng Việt </span><img src="{{ $adminUrl }}/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="{{route('language.index',['en'])}}"><span> English </span><img src="{{ $adminUrl }}/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                            </ul>
                        </li>
